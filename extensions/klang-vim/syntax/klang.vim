...
syn keyword klangKeyword if then else unless for while do do_while end return break continue try catch throw case partial import namespace region alias call function_group operator
