...
syn keyword klangConstant True False None Some Ok Err Result Null DEFAULT
...
syn match klangFieldAccess '\v\.\zs[A-Za-z_][A-Za-z0-9_]*'
...
hi def link klangDocComment SpecialComment
...
hi def link klangFieldAccess Identifier
